                ...
                <div className={StyleSheet.uploading__file__container__main__box}>
                    {uploadeFile.length !== 0 ? (
                        <div
                            ...
                            className={StyleSheet.uploading__file__container__main__box__image__carousel__container}>
                            {uploadeFile.length >= 3 ? (
                                <div
                                    className={StyleSheet.uploading__file__container__main__box__image__carousel__container__left__button}
                                    onClick={(e) => {
                                        Number(
                            ...
                            {uploadeFile.length >= 3 ? (
                                <div
                                    className={StyleSheet.uploading__file__container__main__box__image__carousel__container__right__button}
                                    onClick={(e) => {
