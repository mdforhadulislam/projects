...
import OfflineMonthlyAttendence from './OfflineMonthlyAttendence';

function OfflineMemberDeatils({ setViewDeatils }) {
...
export default OfflineMemberDeatils;
