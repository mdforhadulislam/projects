...
import StyleSheet from '../BoxAndDeatilsStyle/ViewDeatils.module.css';
import ViewDeatilsInRow from './ViewDeatilsRow';

function ViewDeatils({ user, setViewDeatils }) {
...
export default React.memo(ViewDeatils);
