...
const AfterCreateRoutine = () => {
    ...
    return (
        <>
            {!workOut7 && <>
                ...
                {!adjustTimePop && <>
                    ...
                    <div className="d-flex justify-content-end btn-bootom">
                        <button className="cmnBtn border-0 mr-3" onClick={() => setWorkOut7(true)}>Create</button>
            ...
            {/* work out one */}
            {
                workOut7 && <Workout7 setWorkOut7={setWorkOut7} />
            }
        </>
    );
};

export default AfterCreateRoutine;