...
const DietRoutine = () => {
    ...
    return (
        <>
            {routineName && (
                <div
                    id="created-diet-routine"
                    className="created-book-list text-center"
                    onClick={() => setRoutineName(false)}>
                    <i className="">
                        <FaPlus />
                    </i>
            ...
            <div id="diet-routine-section">
                    ...
                    {!routineName && !academy && (
                        <div className="diet-routine-input">
                            ...
                            <div className="get-user-input">
                                <input
                                    id="routine-name"
                                    onchange="handleRoutineName(event)"
                                    type="text"
                            ...
                            <div>
                                ...
                                <div className="choose-date d-flex">
                                    <div className="calendar">
                                        <img
                                            src="../assets/images/icons/calendar-line.svg"
                                            alt="calendar-line"
                                        />
                                    </div>
                                    ...
                                    <div className="select-date-field d-flex">
                                        ...
                                        <div>
                                            <img
                                                ...
                                                src="../assets/images/icons/Polygon 14.svg"
                                                alt=""
                                            />
                                        </div>
                                    </div>
                            ...
                            <div className="d-flex btn-bootom">
                                <button
                                    id="dietChoosDateNextBtn"
                                    className="cmnBtn border-0 mr-3"
                                    onClick={() => setAcademy(true)}>
                                    Next
                                </button>
                                <button id="dietChoosDateCancelBtn" className="cmnBtn">
                                    Cancel
                                </button>
                            </div>
                        </div>
              ...
              <div className="flex">
                ...
                <span id="created-new-dietRoutine" className="text-capitalize"> <i
                  className="" aria-hidden="true"><FaPlusCircle /> </i>created a new routine
                </span>
              </div>
                    ...
                    {academy && (
                        <>
                            <div id="diet-routine-getuserInput">
                                <h5 id="routineName" className="text-left mt-4">
                                    ABCD Academy
                                </h5>
                                <div className="choose-date d-flex  align-items-center">
                                    ...
                                    <div className="select-date-field d-flex">
                                        <div>
                                            <img
                                                className="left-angel"
                                                src="../assets/images/icons/Polygon 15.svg"
                                                alt=""
                                            />
                                        </div>
                                        <input
                            ...
                            <div className="diet-routine-section-table">
                                <div id="diet-routine-table" className="diet-routine-table">
                                    <div className="diet-routine-table-head">
                                        ...
                                        <div
                                            id="dietTimeAdjust"
                                            className="diet-routine-table-head-caption">
                                            <h4>Time</h4>
                                        </div>
                                        <div className="diet-routine-table-head-caption">
                                            <h4>Saturday</h4>
                                    ...
                                    <div
                                        id="diet-routine-table-body"
                                        className="diet-routine-table-body"></div>
                                </div>
                                <button
                                    id="addDietRoutineRow"
                                    className="addMore-btn border-0 float-left">
                                    <img
                                        src="../assets/images/svg/add more plus.svg"
                                        alt="add more plus"
                                    />
                                    Add More
                                </button>
                            ...
                            <div id="diet-routine-table-btn">
                                <div className="d-flex btn-bootom justify-content-end diet-routine-bottom-btn">
                                    <button
                                        id="createDietRoutineBtn"
                                        className="cmnBtn border-0 mr-3">
                                        Create Now
                                    </button>
                                    <button id="cancelDietRoutineBtn" className="cmnBtn">
                                        Cancel
                                    </button>
                                </div>
                                <div className="d-none btn-bootom justify-content-end diet-routine-bottom-btn">
                                    <button
                                        id="afterEditSaveDietRoutineBtn"
                                        className="cmnBtn border-0 mr-3">
                                        Save
                                    </button>
                                    <button id="cancelEditDietRoutineBtn" className="cmnBtn">
                                        Cancel
                                    </button>
                                </div>
                            </div>
