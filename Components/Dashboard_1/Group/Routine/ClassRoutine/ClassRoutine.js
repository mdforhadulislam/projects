...
const ClassRoutine = () => {
    ...
    return (
        <Wrapper>
            {createClassRoutine && (
                <div
                    id="created-class-routine"
                    className="created-book-list text-center"
                    onClick={() => setCreateClassRoutine(false)}>
                    <i className="">
                        <FaPlus />
                    </i>
                ...
                {!academy && !createClassRoutine && (
                    ...
                    <div id="routine-user-input">
                        ...
                        <div className="d-flex chooseday-checkbox">
                            <label
                                htmlFor="saturday"
                                className="checkbox-container text-capitalize">
                                Saturday
                                <input
                                    id="saturday"
                                    type="checkbox"
                            ...
                            <label htmlFor="sunday" className="checkbox-container text-capitalize">
                                sunday
                                <input
                                    id="sunday"
                                    type="checkbox"
                            ...
                            <label htmlFor="monday" className="checkbox-container text-capitalize">
                                monday
                                <input
                                    id="monday"
                                    type="checkbox"
                            ...
                            <label htmlFor="tuesday" className="checkbox-container text-capitalize">
                                tuesday
                                <input
                                    id="tuesday"
                                    type="checkbox"
                            ...
                            <label htmlFor="friday" className="checkbox-container text-capitalize">
                                friday
                                <input
                                    id="friday"
                                    type="checkbox"
                        ...
                        <div className="d-flex btn-bootom">
                            <button
                                id="choosDayNext"
                                className="cmnBtn border-0 mr-3"
                            ...
                            <button
                                id="choosDayCancel"
                                className="cmnBtn"
                                onClick={() => setCreateClassRoutine(true)}>
                                Cancel
                            </button>
                        </div>
                    </div>
                                ...
                                {academy && !create && (
                                    <>
                                        <div className="routine-table-head">
                                            <h4 className="table-head text-capitalize">
                                                Abcd Academy
                                            </h4>
                                        </div>
                                            ...
                                            <div className="order-3 routine-coloum">
                                                <ul className="mx-0 px-0">
                                                    <li className="border-handle">
                                                        <h4 className="selection-day-col mb-0">
                                                            Select
                                                        </h4>
                                                    </li>
                                                    <li>
                                                        {' '}
                                                        <span className="d-block select-time-heading text-left">
                                                            Time
                                                        </span>
                                                    </li>
                                                    {/* {date.map((date, i) =>  ( */}
                                                ...
                                                <div className="order-3 routine-coloum">
                                                    <ul className="mx-0 px-0">
                                                        <li>
                                                            <input
                                                                type="text"
                                                                className="selection-day-col"
                                                                value={`${count(i + 1)} class`}
                                                                readOnly
                                                            />
                                                        </li>
                                                        <li>
                                            ...
                                            <div className="order-4 routine-coloum addColoum-margin">
                                                <ul className="px-0">
                                                    ...
                                                    <li>
                                                        <input
                                                            type="text"
                                                            className="input-class-subject addMore-btn-input"
                                                        />
                                                    </li>
                                                    <li>
                                                        <input
                                ...
                                {create && (
                                    <div id="after-created-routine">
                                        ...
                                        <div className="d-flex routine-table-body-section">
                                            <div
                                                className={`order-3 ${
                                                    add === 'add' ? 'routine-coloum' : 'routine-col'
                                                }`}>
                                                <ul className="mx-0 px-0">
                                                    <li className="border-handle">
                                                        <h4 className="selection-day-col mb-0">
                                                                  ...
                                                                  dayTwo > 0 ? (
                                                                    ...
                                                                    <li>
                                                                        <input
                                                                            type="text"
                                                                            className="input-class-subject"
                                                                            placeholder="Subject Name sunday"
                                                                        />
                                                                    </li>
                                                                )}
                                                            </div>
                                        ...
                                        <div className="d-flex justify-content-end btn-bootom">
                                            ...
                                            {edit && (
                                                <div id="classroutine-editBtn-bottom">
                                                    <button
                                                        id="afterEditRoutineSaveBtn"
                                                        className="cmnBtn mr-3"
                                                        onClick={handleSave}>
                                                        Save
                                                    </button>
                                                    <button
                                                        id="cancelEditRoutineSaveBtn"
                                                        className="cmnBtn mr-3"
