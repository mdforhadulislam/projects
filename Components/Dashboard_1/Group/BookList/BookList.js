...
const BookList = () => {
    ...
    return (
        <>
            ...
            {!addData && (
                <div id="booklist-edit" className="user-edit-input ">
                    ...
                    <div id="booklist-table" className="booklist-table">
                        ...
                        <div className="addBtn-group">
                            {addData && (
                                <button
                                    id="addMore-bookList"
                                    className="addMore-btn px-0"
                                    type="button"
                                    onClick={addFormFields}>
                                    <img src="../assets/images/svg/add more plus.svg" alt="" />
                                    Add More
                                </button>
                            )}
