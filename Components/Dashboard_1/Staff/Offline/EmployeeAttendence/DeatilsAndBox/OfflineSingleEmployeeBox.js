...
function OfflineSingleEmployeeBox({ SetIsDelete, setViewDeatils, setIsEdit }) {
    ...
    return (
        <div className="w-full h-auto py-[6px] px-[8px] shadow-3xl mb-[13px] rounded-[5px] ">
            <div
                ...
                <div className="w-[215px] h-auto flex " style={{ alignItems: 'center' }}>
...
export default OfflineSingleEmployeeBox;
